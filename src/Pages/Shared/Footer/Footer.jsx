    ...
    return (
        <div className='bg-blue-300'>
            <footer className="footer footer-center p-10 ">
                ...
                <div >
                    <p className='flex justify-center items-center text-red-600 font-bold'> <FaCopyright className='mr-1 text-blue-600' /> Copyright © 2023 - All right reserved by Donate Freely Org.</p>
                </div>
            </footer>
        </div>
    );
