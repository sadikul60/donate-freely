    ...
    return (
        <div className='bg-green-100 py-14'>
            <section className='grid grid-cols-1 md:grid-cols-2 gap-8 px-8 pt-6'>
                <div className='text-center text-2xl text-[#0b4341] py-8 px-4 rounded shadow-xl'>
            ...
            <div className='mx-8 md:w-3/4 xl:w-1/2 md:mx-auto text-[#0b4341] text-center text-2xl mt-8 py-8 px-4 rounded shadow-xl'>
