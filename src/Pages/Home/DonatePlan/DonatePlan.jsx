    ...
    return (
        <section className='container mx-auto my-20'>
            <div className='text-center'>
                ...
                <p className='md:w-3/4 md:mx-auto pb-6 text-[20px]'>A donation plan, also known as a giving plan or philanthropic plan, is a structured approach to making charitable contributions. It involves setting specific goals for giving and determining the best ways to allocate funds to different causes or organizations.</p>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                ...
                <div className='bg-blue-400 text-center p-6'>
                    ...
                    <p>Medical care is an important aspect of maintaining the health and well-being of a patient. There are many different types of medical services that a patient may need.</p>
                </div>
                <div className='bg-blue-400 text-center p-6'>
